...
import { Filter, Eye, MapPin, Calendar, Users, Bed, ChevronLeft, ChevronRight, Star } from "lucide-react"
import type { UIBooking } from "@/lib/types"
...
import { GetallBookings, GetallHotelBookingsforAgent } from "@/lib/api"
...
export default function BookingsPage({id}: {id?: string}) {
  ...
  const fetchbookings = async () => {
    const response = await GetallHotelBookingsforAgent(id||"")
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button className="bg-gradient-to-r from-[#023e8a] to-[#00b3d7] hover:from-[#023e8a]/90 hover:to-[#00b3d7]/90 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-2xl px-6">
            Export Bookings
          </Button>
        </div>
      </div>
                ...
                {currentBookings.map((booking) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-gray-900 font-medium">{booking.hotel.starRating} Star</span>
                          </div>
                          <div>
                      ...
                      <TableCell>
                        <Badge className={`${bookingStatus.color} border font-medium`}>{bookingStatus.status}</Badge>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Dialog>
                                        ...
                                        {selectedBooking.room.map((room, index) => (
                                          ...
                                          >
                                            ...
                                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
                                              {room.images.map((image:any, imgIndex:any) => (
                                                <div
                                                  key={imgIndex}
                                            ...
                                            <div className="mt-4 p-3 bg-white rounded-xl shadow-sm">
                                              ...
                                              <div className="flex flex-wrap gap-2">
                                                {room.bedConfiguration.map((bed:any, bedIndex:any) => (
                                                  <Badge
                                                    key={bedIndex}
                                  ...
                                  {selectedBooking.hotel.amenities && (
                                    <div className="bg-gradient-to-br from-[#023e8a]/3 to-[#00b3d7]/3 p-6 rounded-3xl border border-[#00b3d7]/15">
                                      ...
                                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                                        {selectedBooking.hotel.amenities.map((amenity:any, index:any) => (
                                          <div
                                            key={index}
