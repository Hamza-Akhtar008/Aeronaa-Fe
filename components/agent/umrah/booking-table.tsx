...
import { Getallumrahbookings, GetallUmrahBookingsbyAgent } from "@/lib/umrah_api"
...
export function BookingsTable({id}: {id?: string}) {
  ...
  useEffect(() => {
    const getallbookings = async () => {
      const response = await GetallUmrahBookingsbyAgent(id||"")
