...
export async function  generatepdfflight  (
  ticket: Ticket,
  ...
  if (typeof window === "undefined") {
    throw new Error("PDF generation must run on the client only.");
  }
          ...
          <div class="header-content">
            <div class="company-info">
              <div class="logo-section">
                <img src="/images/Aeronaa-Logo.png" alt="Aeronaa" style="width: 100px; height: 100px; object-fit: contain; margin-right: 20px;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
          ...
          <div class="flight-summary">
            ...
            <div class="flight-details">
              ...
              <div class="detail-item">
                ...
                <div class="detail-value">${ticket.cabbinBaggage?ticket.cabbinBaggage:"Not Included"}</div>
              </div>
            </div>
          </div>
  ...
  `;
   ...
   const opt = {
  margin:       [10, 10, 10, 10], // add some breathing space
  filename:     "invoice.pdf",
  image:        { type: "jpeg", quality: 1 },
  html2canvas:  { scale: 2, useCORS: true },
  jsPDF:        { unit: "pt", format: "a4", orientation: "portrait" },
  pagebreak: { mode: ['avoid-all', 'css', 'legacy'] } // <--- allow proper page breaks
};
