...
const revenueByCategory = [
  ...
  { name: "Property", value: 425000, color: "#f59e0b" },
  { name: "Umrah", value: 315000, color: "#10b981" },
  { name: "Flight", value: 192500, color: "#0ea5e9" },
  { name: "Car", value: 128000, color: "#6366f1" },
]
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="group border-0 bg-white shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] rounded-3xl overflow-hidden relative">
          <div className="absolute inset-0 bg-gradient-to-br from-amber-50 to-amber-100/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
          ...
          <CardContent className="relative z-10">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 px-2 py-1 bg-amber-100 rounded-full">
                ...
                <span className="text-xs text-amber-700 font-semibold">+15.3%</span>
              </div>
              <p className="text-xs text-gray-500">from last month</p>
            </div>
          </CardContent>
      ...
      <Card className="border-0 bg-white shadow-lg rounded-3xl overflow-hidden">
        <CardHeader className="pb-4">
          <CardTitle className="text-xl font-bold text-gray-900">Bookings per Service Type</CardTitle>
          <CardDescription className="text-gray-600 mt-1">
            Number of bookings and revenue by service category
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={bookingsPerServiceData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" />
